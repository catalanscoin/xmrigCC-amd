...
constexpr const uint32_t CRYPTONIGHT_CAT_ITER      = 0x6000;
...
template<> inline constexpr uint32_t cn_select_iter<CRYPTONIGHT_FEMTO, VARIANT_TURTLE>()  { return CRYPTONIGHT_CAT_ITER; }
